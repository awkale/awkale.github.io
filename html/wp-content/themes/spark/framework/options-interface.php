...
function optionsframework_fields() {
	...
	foreach ($options as $value) {
       ...
       // $output .= "<div class='sidebar_management'>";  
        ...
        $output .= '<input type="text" id="new_sidebar_name" class="of-input"/> <input class="button-primary" type="button" id="add_sidebar" value="'.__("add", $themename).'" />'; 
		//$output .= '<input id="' . esc_attr( $value['id'] ) . '" class="of-input" name="' . esc_attr( $option_name . '[' . $value['id'] . ']' ) . '" type="text" value="' . esc_attr( $val ) . '" />';
       ...
       $output .= "<div class='sidebar_management'>"; 
        ...
        {  
            ...
            {  
                $output .= "".$sidebar." <a href='#' class='delete'>".__("delete", $themename)."</a> <input type='hidden' name='twentyeleven_theme_options[custom_sidebar][]' value='".$sidebar."' />";  
                $i++;  
            }  
        }  
