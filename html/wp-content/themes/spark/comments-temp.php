...
================================================== -->
      ...
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
       ...
       <div class="span4">
        ...
        <input type="text" class="span4 req-string required requiredField" placeholder="Type something…" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" tabindex="1">
        ...
        <input class=" span4 required requiredField email" placeholder="Type something…" type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" tabindex="2" >
        
        <label for="url"><?php _e('Website', 'csc-themewp'); ?></label>
        <input type="text"  class="span4" name="url" id="url" placeholder="Type something…" value="<?php echo esc_attr($comment_author_url); ?>" tabindex="3" />

        </div>
        
        <?php endif; ?>
        <div style="position:relative;width:96%; float:right">

        <label><?php _e('Your message', 'csc-themewp'); ?> <small><?php _e("<i class=\"icon-asterisk\"></i>", 'csc-themewp'); ?></small></label>
        <textarea class="req-string" rows="5" name="comment" id="comment" style="width:99%; margin-bottom:20px;"></textarea>
