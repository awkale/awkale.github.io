...
?>
           ...
           <?php 
			...
			$humb = vt_resize( '', $image, 233, 233, true );
			?>
                       
                        
          <li class="span3 <?php echo strtolower($tax); ?> all item-block item-gallery">
							...
							<div class="port-info-wrap">
								...
								<div class="port-info">
									...
									<div class="port-info-back">
                                       ...
                                       <a href="<?php print  portfolio_thumbnail_url($post->ID) ?>" rel="prettyPhoto" title="<?php echo get_the_title(); ?>" class="zoom"></a>
